...
* @root: The pointer to the root node of the BST to search.
*
* Return: A minimum value in @tree.
*/
bst_t *inorder_successor(bst_t *root)
{
...
/**
* bst_delete - Deletes the node from a binary search tree.
* @root: the pointer to the root node of the BST.
* @node: The pointer to the node to delete from the BST.
*
* Return: The pointer to the new root node after deletion.
*/
bst_t *bst_delete(bst_t *root, bst_t *node)
{
bst_t *parent = node->parent, *successor = NULL;

/* No childrens or right-child only */
if (node->left == NULL)
{
...
/**
* bst_remove - Removes the node from a binary search tree.
* @root: The pointer to the root node of the BST to remove a node from.
* @value: A value to remove in the BST.
*
* Return: The pointer to the new root node after deletion.
*
* Description: If a node to be deleted has two children, it
*              it's replaced with its first in-order successor.
*/
bst_t *bst_remove(bst_t *root, int value)
{
